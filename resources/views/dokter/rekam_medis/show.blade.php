...
<div class="container mx-auto p-4 max-w-2xl">
    ...
    <div class="mt-4 flex gap-2">
        <a href="{{ route('dokter.rekam_medis.index') }}" 
           class="bg-pink-300 hover:bg-pink-400 text-white px-4 py-2 rounded font-medium shadow">
           Kembali
        </a>
        <a href="{{ route('dokter.rekam_medis.edit', $rekamMedis->id) }}" 
           class="bg-pink-200 hover:bg-pink-300 text-pink-800 px-4 py-2 rounded font-medium shadow">
           Edit
        </a>
    </div>
</div>
